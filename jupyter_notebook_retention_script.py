...
print x
# scoring_data = "SELECT A.* FROM (SELECT * FROM  CTG_ANALYTICS_WS.SM_RETENTION_MODEL  WHERE   TAX_YEAR=2016 AND CUSTOMER_DEFINITION_ADJ='NEW TO TURBOTAX' )A inner join (SELECT DISTINCT CUSTOMER_KEY FROM  CTG_ANALYTICS_WS.SM_RETENTION_MODEL  WHERE   TAX_YEAR=2016 AND TAX_DAY>=112) B ON A.CUSTOMER_KEY=B.CUSTOMER_KEY "
# data = "SELECT * FROM (SELECT * FROM  CTG_ANALYTICS_WS.SM_RETENTION_MODEL  WHERE   TAX_YEAR<2015 AND TAX_DAY<=150 AND CUSTOMER_DEFINITION_ADJ='NEW TO TURBOTAX'  )A   order by random() limit 100000"

# lOYAL
# scoring_data = "SELECT A.* FROM (SELECT CUSTOMER_KEY,TAX_DAY,TAX_DAY_PY,TAX_DAY_PY2,TAX_DAY_PY3,	ABANDONED,	AGE_DEPENDENT_MAX,	AGE_DEPENDENT_MAX_PY,	AGE_DEPENDENT_MAX_PY2,	AGE_DEPENDENT_MIN_PY,	AGE_DEPENDENT_MIN_PY2,	AGE_SPOUSE_PY2,	AGE_TAXPAYER_PY,	AGE_TAXPAYER_PY2,	AMOUNT_ADJUSTMENTS,	AMOUNT_CHILD_CREDIT,	AMOUNT_EDUCATION_CREDIT_PY2,	AMOUNT_EXEMPTIONS_PY,	AMOUNT_INCOME_TAX_WITHHELD_PY,	AMOUNT_MEDICAL_DENTAL_EXPENSES_DEDUCTION_PY2,	AMOUNT_ORDINARY_DIVIDENDS_PY,	AMOUNT_REFUND,	AMOUNT_SALARIES_AND_WAGES_PY,	AMOUNT_SCHE_PY,	AMOUNT_SCHE_PY2,	AMOUNT_SOCIAL_SEC_PY2,	AMOUNT_TAX_DUE_PY,	AMOUNT_TAXABLE_INCOME,	AMOUNT_TAXABLE_SOCIAL_SEC_PY,	AMOUNT_TOTAL_CREDITS_PY,	AMOUNT_TOTAL_DEDUCTIBLE_EXPENSES_PY,	AUDIT_DEFENSE_FLAG,	AUTH_NOT_COMPLETE_PY2,	AUTH_NOT_COMPLETE_PY3,	BUS_COGS_TOTAL_PY2,	BUS_EXPENSE_EMPLOYEE_BENEFITS_PY2,	BUS_GROSS_INCOME_PY3,	BUS_NET_PROFIT,	CHANNEL,	CHANNEL_PY,	COMPLETED_SKU,	COMPLETED_SKU_PY,	COMPLETED_SKU_PY2,	COMPLETED_SKU_PY3,	CUSTOMER_DEFINITION_ADJ,	CUSTOMER_DEFINITION_ADJ_PY,	CUSTOMER_DEFINITION_ADJ_PY2,	ENTRY_PAGE_GROUP,	ENTRY_PAGE_GROUP_PY,	FED_FORM_TYPE,	FED_FORM_TYPE_PY,	FED_FORM_TYPE_PY2,	FILING_STATUS,	FILING_STATUS_PY,	FILING_STATUS_PY2,	FILING_STATUS_PY3,	FLAG_ITEMIZED_DEDUCTIONS_PY,	FLAG_OLD_OR_BLIND,	FLAG_OLD_OR_BLIND_PY,	FSCHA_FLAG,	FSCHE_FLAG,	IMPORT_TYPE,	IMPORT_TYPE_PY,	IMPORT_TYPE_PY2,	LAST_STATUS,	LAST_STATUS_PY3,	MISC1099_FLAG,	NON_CA_REFUND_TRANSFER_FLAG,	NON_CA_REFUND_TRANSFER_FLAG_PY2,	NON_CA_REFUND_TRANSFER_REVENUE,	NUM_W2_PY2,	PRODUCT_EDITION_DESCRIPTION,	PRODUCT_EDITION_DESCRIPTION_PY3,	PRODUCT_ROLLUP,	PRODUCT_ROLLUP_PY2,	PRODUCT_ROLLUP_PY3,	REFUND_TRANSFER_FLAG,	REFUND_TRANSFER_FLAG_PY3,	REQUIRED_TAKE_FLAG,	REQUIRED_TAKE_FLAG_PY,	RISK_FLAG,	START_SKU_PY,	START_SKU_PY2,	START_SKU_ROLLUP_PY,	SUP_PS_AT_RISK,	SUP_PS_AT_RISK_PY2,	SUP_PS_PARTNERSHIP_PY,	SUP_PS_PARTNERSHIP_PY2,	SUP_RE_EXPENSES_TOTAL,	SUP_RE_EXPENSES_TOTAL_PY3,	SUP_RE_INCOME_RENTS,	SUP_RE_TYPE_ROYALTIES_PY3,	SUP_RE_TYPE_SELF_RENTAL_PY,	TTO_FLAG_PY2 FROM  CTG_ANALYTICS_WS.SM_RETENTION_MODEL  WHERE   TAX_YEAR=2016 and customer_definition_adj in ('LOYAL','LOYAL 5+')  )A inner join (SELECT DISTINCT CUSTOMER_KEY FROM  CTG_ANALYTICS_WS.SM_RETENTION_MODEL  WHERE   TAX_YEAR=2016 AND TAX_DAY>=112) B ON A.CUSTOMER_KEY=B.CUSTOMER_KEY "
# data = "SELECT * FROM (SELECT CUSTOMER_KEY,TAX_DAY,TAX_DAY_PY,TAX_DAY_PY2,TAX_DAY_PY3,	ABANDONED,	AGE_DEPENDENT_MAX,	AGE_DEPENDENT_MAX_PY,	AGE_DEPENDENT_MAX_PY2,	AGE_DEPENDENT_MIN_PY,	AGE_DEPENDENT_MIN_PY2,	AGE_SPOUSE_PY2,	AGE_TAXPAYER_PY,	AGE_TAXPAYER_PY2,	AMOUNT_ADJUSTMENTS,	AMOUNT_CHILD_CREDIT,	AMOUNT_EDUCATION_CREDIT_PY2,	AMOUNT_EXEMPTIONS_PY,	AMOUNT_INCOME_TAX_WITHHELD_PY,	AMOUNT_MEDICAL_DENTAL_EXPENSES_DEDUCTION_PY2,	AMOUNT_ORDINARY_DIVIDENDS_PY,	AMOUNT_REFUND,	AMOUNT_SALARIES_AND_WAGES_PY,	AMOUNT_SCHE_PY,	AMOUNT_SCHE_PY2,	AMOUNT_SOCIAL_SEC_PY2,	AMOUNT_TAX_DUE_PY,	AMOUNT_TAXABLE_INCOME,	AMOUNT_TAXABLE_SOCIAL_SEC_PY,	AMOUNT_TOTAL_CREDITS_PY,	AMOUNT_TOTAL_DEDUCTIBLE_EXPENSES_PY,	AUDIT_DEFENSE_FLAG,	AUTH_NOT_COMPLETE_PY2,	AUTH_NOT_COMPLETE_PY3,	BUS_COGS_TOTAL_PY2,	BUS_EXPENSE_EMPLOYEE_BENEFITS_PY2,	BUS_GROSS_INCOME_PY3,	BUS_NET_PROFIT,	CHANNEL,	CHANNEL_PY,	COMPLETED_SKU,	COMPLETED_SKU_PY,	COMPLETED_SKU_PY2,	COMPLETED_SKU_PY3,	CUSTOMER_DEFINITION_ADJ,	CUSTOMER_DEFINITION_ADJ_PY,	CUSTOMER_DEFINITION_ADJ_PY2,	ENTRY_PAGE_GROUP,	ENTRY_PAGE_GROUP_PY,	FED_FORM_TYPE,	FED_FORM_TYPE_PY,	FED_FORM_TYPE_PY2,	FILING_STATUS,	FILING_STATUS_PY,	FILING_STATUS_PY2,	FILING_STATUS_PY3,	FLAG_ITEMIZED_DEDUCTIONS_PY,	FLAG_OLD_OR_BLIND,	FLAG_OLD_OR_BLIND_PY,	FSCHA_FLAG,	FSCHE_FLAG,	IMPORT_TYPE,	IMPORT_TYPE_PY,	IMPORT_TYPE_PY2,	LAST_STATUS,	LAST_STATUS_PY3,	MISC1099_FLAG,	NON_CA_REFUND_TRANSFER_FLAG,	NON_CA_REFUND_TRANSFER_FLAG_PY2,	NON_CA_REFUND_TRANSFER_REVENUE,	NUM_W2_PY2,	PRODUCT_EDITION_DESCRIPTION,	PRODUCT_EDITION_DESCRIPTION_PY3,	PRODUCT_ROLLUP,	PRODUCT_ROLLUP_PY2,	PRODUCT_ROLLUP_PY3,	REFUND_TRANSFER_FLAG,	REFUND_TRANSFER_FLAG_PY3,	REQUIRED_TAKE_FLAG,	REQUIRED_TAKE_FLAG_PY,	RISK_FLAG,	START_SKU_PY,	START_SKU_PY2,	START_SKU_ROLLUP_PY,	SUP_PS_AT_RISK,	SUP_PS_AT_RISK_PY2,	SUP_PS_PARTNERSHIP_PY,	SUP_PS_PARTNERSHIP_PY2,	SUP_RE_EXPENSES_TOTAL,	SUP_RE_EXPENSES_TOTAL_PY3,	SUP_RE_INCOME_RENTS,	SUP_RE_TYPE_ROYALTIES_PY3,	SUP_RE_TYPE_SELF_RENTAL_PY,	TTO_FLAG_PY2 FROM  CTG_ANALYTICS_WS.SM_RETENTION_MODEL  WHERE TAX_YEAR=2014  and customer_definition_adj in ('LOYAL','LOYAL 5+')  )A   order by random() limit 1000000"

# NEW
scoring_data = "SELECT   A.* FROM (SELECT  distinct  CUSTOMER_KEY,  AUDIT_DEFENSE_FLAG,	FLAG_OLD_OR_BLIND,	FSCHA_FLAG,	MISC1099_FLAG,	NON_CA_REFUND_TRANSFER_FLAG,	REQUIRED_TAKE_FLAG,	student_taxpayer,	AGE_DEPENDENT_MIN,	AMOUNT_EITC,	AMOUNT_ESTIMATED_TAX_PENALTY,	AMOUNT_EXEMPTIONS,	AMOUNT_EXPENSES_DEDUCTION,	AMOUNT_INCOME_TAX_WITHHELD,	AMOUNT_TAXABLE_INCOME,	AMOUNT_TOTAL_DEDUCTIONS,	AMOUNT_TOTAL_TAX,	BUS_COGS_TOTAL,	REJECT_COUNT,	SUP_PS_PARTNERSHIP,	CHANNEL,	ENTRY_PAGE_GROUP,	FED_FORM_TYPE,	PRODUCT_ROLLUP,	LAST_STATUS,	DMA_AREA,	ACCEPTED_EFILE,	AGE_DEPENDENT_MAX,	AGE_TAXPAYER,	AMOUNT_ADJUSTMENTS,	AMOUNT_BUSINESS_INCOME,	AMOUNT_CHARITABLE_CONTRIBUTIONS,	AMOUNT_CHARITABLE_CONTRIBUTIONS_CASH,	AMOUNT_EDUCATION_CREDIT,	AMOUNT_EXCESS_SS_RRTA_WITHHELD,	AMOUNT_MEDICAL_DENTAL_EXPENSES,	AMOUNT_MEDICAL_DENTAL_EXPENSES_DEDUCTION,	AMOUNT_ORDINARY_DIVIDENDS,	AMOUNT_OTHER_TAXES,	AMOUNT_QUALIFIED_DIVIDENDS,	BUS_COGS_INVENTORY_END,	BUS_COGS_INVENTORY_START,	BUS_COGS_PURCHASES,	BUS_EXPENSE_EMPLOYEE_BENEFITS,	BUS_EXPENSE_PENSION,	BUS_GROSS_INCOME,	BUS_REQUIRE_1099,	BUS_VEHICLE_MILES_BUSINESS,	BUS_WILL_FILE_1099,	CA_REFUND_TRANSFER_FLAG,	cook_taxpayer,	customerservice_taxpayer,	FSCHC_FLAG,	FSCHCEZ_FLAG,	FSCHD_FLAG,	FSCHE_FLAG,	homemaker_spouse,	laborer_taxpayer,	manager_taxpayer,	NON_CA_AUDIT_DEFENSE_FLAG,	NUM_EXEMPTIONS,	NUM_W2,	sales_taxpayer,	server_taxpayer,	SUP_EST_TOTAL_INCOME,	SUP_FARM_GROSS_INCOME,	SUP_FARM_RENTAL_INCOME,	SUP_PS_AT_RISK,	SUP_RE_EXPENSES_TOTAL,	SUP_RE_TOTAL_INCOME,	SUP_RE_TYPE_ROYALTIES,	TAX_DAY,	teacher_taxpayer,	START_SKU,	IMPORT_TYPE,	PRODUCT_EDITION_DESCRIPTION,	COMPLETED_SKU,	FILING_STATUS FROM  CTG_ANALYTICS_WS.SM_RETENTION_MODEL  WHERE   TAX_YEAR=2016  )A inner join (SELECT DISTINCT CUSTOMER_KEY FROM  CTG_ANALYTICS_WS.SM_CUSTOMER_RETENTION_BASE  WHERE   TAX_YEAR=2016 AND TAX_DAY=%d AND TTO_FLAG=1 AND CORE_FLAG=1  ) B ON A.CUSTOMER_KEY=B.CUSTOMER_KEY"%x
data = "SELECT * FROM (SELECT     CUSTOMER_KEY, ABANDONED,AUDIT_DEFENSE_FLAG,	FLAG_OLD_OR_BLIND,	FSCHA_FLAG,	MISC1099_FLAG,	NON_CA_REFUND_TRANSFER_FLAG,	REQUIRED_TAKE_FLAG,	student_taxpayer,	AGE_DEPENDENT_MIN,	AMOUNT_EITC,	AMOUNT_ESTIMATED_TAX_PENALTY,	AMOUNT_EXEMPTIONS,	AMOUNT_EXPENSES_DEDUCTION,	AMOUNT_INCOME_TAX_WITHHELD,	AMOUNT_TAXABLE_INCOME,	AMOUNT_TOTAL_DEDUCTIONS,	AMOUNT_TOTAL_TAX,	BUS_COGS_TOTAL,	REJECT_COUNT,	SUP_PS_PARTNERSHIP,	CHANNEL,	ENTRY_PAGE_GROUP,	FED_FORM_TYPE,	PRODUCT_ROLLUP,	LAST_STATUS,	DMA_AREA,	ACCEPTED_EFILE,	AGE_DEPENDENT_MAX,	AGE_TAXPAYER,	AMOUNT_ADJUSTMENTS,	AMOUNT_BUSINESS_INCOME,	AMOUNT_CHARITABLE_CONTRIBUTIONS,	AMOUNT_CHARITABLE_CONTRIBUTIONS_CASH,	AMOUNT_EDUCATION_CREDIT,	AMOUNT_EXCESS_SS_RRTA_WITHHELD,	AMOUNT_MEDICAL_DENTAL_EXPENSES,	AMOUNT_MEDICAL_DENTAL_EXPENSES_DEDUCTION,	AMOUNT_ORDINARY_DIVIDENDS,	AMOUNT_OTHER_TAXES,	AMOUNT_QUALIFIED_DIVIDENDS,	BUS_COGS_INVENTORY_END,	BUS_COGS_INVENTORY_START,	BUS_COGS_PURCHASES,	BUS_EXPENSE_EMPLOYEE_BENEFITS,	BUS_EXPENSE_PENSION,	BUS_GROSS_INCOME,	BUS_REQUIRE_1099,	BUS_VEHICLE_MILES_BUSINESS,	BUS_WILL_FILE_1099,	CA_REFUND_TRANSFER_FLAG,	cook_taxpayer,	customerservice_taxpayer,	FSCHC_FLAG,	FSCHCEZ_FLAG,	FSCHD_FLAG,	FSCHE_FLAG,	homemaker_spouse,	laborer_taxpayer,	manager_taxpayer,	NON_CA_AUDIT_DEFENSE_FLAG,	NUM_EXEMPTIONS,	NUM_W2,	sales_taxpayer,	server_taxpayer,	SUP_EST_TOTAL_INCOME,	SUP_FARM_GROSS_INCOME,	SUP_FARM_RENTAL_INCOME,	SUP_PS_AT_RISK,	SUP_RE_EXPENSES_TOTAL,	SUP_RE_TOTAL_INCOME,	SUP_RE_TYPE_ROYALTIES,	TAX_DAY,	teacher_taxpayer,	START_SKU,	IMPORT_TYPE,	PRODUCT_EDITION_DESCRIPTION,	COMPLETED_SKU,	FILING_STATUS FROM  CTG_ANALYTICS_WS.SM_RETENTION_MODEL  WHERE   TAX_YEAR=2014    )A   order by random() limit 1000000"
# 'PY SKIPPER', 'PY SKIPPER - PAST SKIPPER',
...
def transform_to_pca(data,df_pca, fitted_pca, do_pca):
...
def bin_pca_score_set(df_trans_pca, length_dict, b_pca):
...
def score_set_feature_selection(x, plsca, fc):
    if fc=='True':
        x3 = plsca.transform(x)
        string = "pls_"
        pls_column_name = [string + `i` for i in range(x3.shape[1])]
...
dummy_pca, length_dict = bin_pca(df_pca, bool_df, df_cont, b_pca=j)
...
df_trans_pca = transform_to_pca(data, df_pca, fitted_pca, do_pca=i)
scoring_df_trans = bin_pca_score_set(df_trans_pca, length_dict, b_pca=j)
x = data
# x = get_scoring_arrays(scoring_df_trans)

print 'reducing dimensionality for scoring dataset...'
x_score, index=score_set_feature_selection(x,plsca, fc=k)
...
defection.to_csv(path_or_buf='defection_model_prediction_skip.txt', index=True)
